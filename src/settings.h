...
struct SimulationSettings
{
    ...
    inline static float scale_factor = 30.0f;
};
...
struct ParticleSettings
{
    ...
    inline static const unsigned int particle_count = 300'000;
    ...
    inline static uint32_t CellsX = 500;
    inline static uint32_t CellsY = CellsX / SimulationSettings::aspect_ratio;
	inline static const uint32_t cell_max_capacity = 5;
